...
<div>
	...
	<section class="banner_zi">
	    <div><img src="images/town_cuisine.jpg" alt=""></div>	   
	</section>
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="home-page.php">首页 </a> > <span class="active"><a href="town_cuisine.php">古城味道 </a> </span>
	</div>
		<div class="travel_con">
			<div class="top_qie">
				<a href="town_cuisine.php" class="active">古城味道</a>
				<a href="town_lodging.php">古城住宿</a>
				<a href="town_stroll.php" >古城漫游</a>
			    <a href="town_shopping.php" >古城购物</a>
			</div>
			<div class="tra_ul">
...
//选择库
		...
		?>
					<li class="wow bounceIn">
					   ...
					   <a href="town_show1.php?id=<?php echo $row['id']?>"><?php echo $row['title']."</br>"; ?></a>

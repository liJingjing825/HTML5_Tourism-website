...
<div>
		  ...
		  <div class="logo_right">
		  	  <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="scenic_overview.php" class="active">大美古城</a></li>
	...
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="home-page">首页 </a> > <span class="active">创意路线</span>
	</div>
			...
			<div class="tu_qie clearfix">
				...
				<div class="right">
					<ul>
						...
						<li>
							<div class="pic_li">
								<img src="images/meitu_1.jpg" alt="" class="vcenter" />
								<i></i>
							</div>
						</li>
						<li>
	...
	<div class="home_news">
		<div class="news_con">
			<div class="top_tit">
				<span class="span1"><a href="news.html">旅游动态</a></span><br />

	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
          ...
          <?php $link=mysql_connect("localhost","root","root");//连接数据库
           ...
           $sql="select * from `admin` where uid like '%$keywords%'";
           $rs=mysql_query($sql);
	       ...
	       ?>
	        <tr>
			  ...
			  <td style="vertical-align: middle; text-align: center; "><a href="admin-del.php?id=<?php echo $row['id']?>">
			  <button type="button" class="btn"  style="background-color: #5A98DE;color: #FFFFFF;border-radius:5px">
               删除
              </button></a>
			  </td> 
		      </tr>

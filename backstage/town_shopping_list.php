...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 古城<span class="c-gray en">&gt;</span> 商品管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px;background-color: #84A76C" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		<form action="town_shopping_search_list.php" method="post">
		 <input type="text" name="keywords" id="" placeholder=" 美食名" style="width:250px" class="input-text">
		 <button name="" id="" class="btn btn-success" type="submit" style="background-color: #84A76C;"><i class="Hui-iconfont">&#xe665;</i>搜商品名</button>
		</form>
	</div>
...
?>
	        <tr>
			  ...
			  <a href="php/town_shopping_del.php?id=<?php echo $row['id']?>">

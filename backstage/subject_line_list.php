...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 路线管理<span class="c-gray en">&gt;</span> 主题路线管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px;background-color: #84A76C" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
$sql ="SELECT count(*) as 'count' from subject_line";//查询记录的sql语句
...
//选择库
           $sql1="select * from `subject_line`  order by id desc limit $start,$pagesize";
           $rs=mysql_query($sql1);

		  ...
		  <div class="logo_right">
		  	 <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="court_travel.php"  class="active">创意路线</a>
		   				<ul>
	...
	<div class="news_zi">
		<div class="top_qie">
		    <a href="customized.php" >私人定制</a>
		   	<a href="classic_route.php" class="active">经典路线</a>
...
$sql ="SELECT count(*) as 'count' from classic_route";//查询记录的sql语句
...
//选择库
           $sql1="select * from `classic_route` order by time desc limit $start,$pagesize";
           $rs=mysql_query($sql1);
...
?>
			<li class="clearfix">
				<div class="news_left clearfix">
					<div class="pic">
						<a href="travel_show.php"> <img src="<?php echo 'backstage/'.$row['pic1']; ?>"  width='100%' height='100%' border='0' /></a>
						<i></i>
					</div>
					<div class="txt">
						<a href="travel_show1.php?title=<?php echo $row['title']?>"><?php echo $row['title']."</br>"; ?></a>
						<p class="p1">

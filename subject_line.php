	...
	<div class="news_zi">
		<div class="top_qie">
		    <a href="customized.php" >私人定制</a>
		   	...
		   	<a href="subject_line.php"class="active">主题路线</a>
		</div>
...
//选择库
           $sql1="select * from `subject_line` order by time desc limit $start,$pagesize";
           $rs=mysql_query($sql1);
...
?>
			<li class="clearfix">
				<div class="news_left clearfix">
					<div class="pic">
						 <img src="<?php echo 'backstage/'.$row['pic1']; ?>"  width='100%' height='100%' border='0' />
						<i></i>
					</div>
					<div class="txt">
						<a href="travel_show2.php?title=<?php echo $row['title']?>"><?php echo $row['title']."</br>"; ?></a>
						<p class="p1">
